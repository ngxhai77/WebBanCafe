...
namespace Quanlycafe.Areas.Admin.Controllers
{
    public class LoaihangsController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            Loaihang hangsanxuat = db.Loaihang.Find(id);
            if (hangsanxuat == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult Create([Bind(Include = "Mahang,Tenhang")] Loaihang hangsanxuat)
        {
            if (ModelState.IsValid)
            {
                db.Loaihang.Add(hangsanxuat);
                db.SaveChanges();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Mahang,Tenhang")] Loaihang hangsanxuat)
        {
            if (ModelState.IsValid)
            {
        ...
        {
            Loaihang hangsanxuat = db.Loaihang.Find(id);
            db.Loaihang.Remove(hangsanxuat);
            db.SaveChanges();
            return RedirectToAction("Index");
        }
